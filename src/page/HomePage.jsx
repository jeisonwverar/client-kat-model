...
const HomePage = () => {
  return (
    <div className=" grid grid-cols-2 gap-2 sm:grid-row-2">
      ...
      <Link to="/register"className=" text-center text-white bg-brand-secondary hover:bg-white hover:text-brand-secondary hover:border-2 border-brand-secondary  focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" >registrate ahora</Link>
      </div>
